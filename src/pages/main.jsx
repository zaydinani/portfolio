...
function Main() {
  ...
  return (
    <>
      {/* scroll up */}
      <Link to="hero" spy={true} smooth={true} duration={1000} offset={0}>
      ...
      <Element name="about" id="about">
        <section className="about container" id="about">
            ...
            <div>
              <ul>
                <li className=" btn main-btn">
                  <a href="/resume/zayd inani english.pdf" download>
                    download cv
                  </a>
                </li>
              </ul>
          ...
          <div className="imgContainer" xyz="fade right">
            <img
              src={data["zayd-data"].about.image}
              alt="Zayd Inani personal image"
            />
          </div>
        </section>
      </Element>
            ...
            {emailStatus === "success" && (
              <div class="alert alert-2-success">
                ...
                <p class="alert-content">
                  your email have been sent successfully
                </p>
              </div>
            )}
            {emailStatus === "error" && (
